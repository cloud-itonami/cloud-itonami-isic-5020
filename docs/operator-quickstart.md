# Operator Quickstart — Water freight transport (tanker)

Shortest path from clone to a verified local dry-run for **ISIC 5020** (`cloud-itonami-isic-5020`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5020.git
cd cloud-itonami-isic-5020
```
...
- Blueprint governor key: `marine-cargo-governor`
- Likely source path: `tanker.governor.cljc`
